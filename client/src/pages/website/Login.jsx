        ...
        <div className="w-full lg:flex-1 lg:w-[48%] flex flex-col justify-between py-1 sm:py-2 px-1 sm:px-3 lg:px-6">
          ...
          <div className="my-auto py-5 sm:py-7 max-w-md w-full mx-auto">
            ...
            <div className="relative my-6 text-center">
              ...
              <span className="relative bg-white dark:bg-slate-900 px-3 text-xs text-slate-400 dark:text-slate-500 font-medium">
            ...
            <div className="flex items-center justify-center gap-3.5">
              ...
              <button
                ...
                className="w-11 h-11 rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-sm flex items-center justify-center hover:bg-slate-50 dark:hover:bg-slate-750 hover:border-slate-300 dark:hover:border-slate-600 hover:scale-105 active:scale-95 transition-all cursor-pointer"
              >
              ...
              <button
                ...
                className="w-11 h-11 rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-sm flex items-center justify-center hover:bg-slate-50 dark:hover:bg-slate-750 hover:border-slate-300 dark:hover:border-slate-600 hover:scale-105 active:scale-95 transition-all cursor-pointer text-slate-900 dark:text-white"
              >
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                  <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M15.97 6.37c.62-.75 1.04-1.8 1.01-2.85-.9.04-1.98.6-2.62 1.35-.57.65-1.07 1.7-1 2.76 1 .08 1.99-.51 2.61-1.26z" />
                </svg>
              </button>
              ...
              <button
                type="button"
                onClick={handleSocialLogin}
                title="Continue with Microsoft / Facebook SSO"
                className="w-11 h-11 rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-sm flex items-center justify-center hover:bg-slate-50 dark:hover:bg-slate-750 hover:border-slate-300 dark:hover:border-slate-600 hover:scale-105 active:scale-95 transition-all cursor-pointer"
              >
              ...
              <button
                type="button"
                onClick={handleSocialLogin}
                title="Continue with Enterprise SSO"
                className="w-11 h-11 rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-sm flex items-center justify-center hover:bg-slate-50 dark:hover:bg-slate-750 hover:border-slate-300 dark:hover:border-slate-600 hover:scale-105 active:scale-95 transition-all cursor-pointer text-slate-900 dark:text-white"
              >
